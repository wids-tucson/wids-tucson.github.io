...
| [\~8:45am - 9:00am]{style="color:#0caacf"}    | [Arrival]{style="color:#0caacf"} [Coffee + pastries]{style="color:#0caacf"}^[𝛼]{style="color:#0caacf;"}^ |                                                                                                                   | [Welcome]{style="color:#0caacf"}                                                                                                                                      |
...
^[𝛼]{style="color:#0caacf;"}^[provided by University of Arizona Data Science Institute]{style="color:#0caacf"}
