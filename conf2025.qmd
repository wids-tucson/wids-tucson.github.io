...
| [\~8:45am - 9:00am]{style="color:#0caacf"}    | [Arrival]{style="color:#0caacf"} [Coffee + pastries]{style="color:#0caacf"}^[𝛼]{style="color:#0caacf;"}^ | Kristina Riemer                                                                                                   | Welcome                                                                                                                                                               |
| [**9:00am - 9:45am**]{style="color:#0caacf;"} | [**Keynote**]{style="color:#0caacf;"}                                                                    | [**Catherine D'Ignazio**]{style="color:#0caacf;"}                                                                 | [**Data Feminism in Action**]{style="color:#0caacf;"}                                                                                                                 |
| 10:00am - 10:20am                             | Invited Speaker Session                                                                                  | Ashley Huggins                                                                                                    | Mapping the brain in PTSD: leveraging global, large-scale neuroimaging datasets to identify structural and functional neural markers of posttraumatic stress disorder |
| 10:20am - 10:40am                             | Invited Speaker Session                                                                                  | Laura Falk                                                                                                        | API Key Basics: Unlocking Data Possibilities                                                                                                                          |
| 10:40am - 11:00am                             | Invited Speaker Session                                                                                  | Salena Torres Ashton                                                                                              | What is Probability and Why Does it Matter for Data Science?                                                                                                          |
| 11:00am - 11:30am                             | Data Blitz                                                                                               | Ashwini Jannu, Delaney Scott-Martin, Liliana Salas, Abadit Weldeslassie, Deandra Jones, Mary Ahern, and Jiayue He | Check out the [Data Blitz](dataBlitz2025.qmd) page!                                                                                                                   |
| [11:30am - 12:30pm]{style="color:#0caacf;"}   | [Morning Panel]{style="color:#0caacf;"}                                                                  | [Meghavarshini (Megh) Krishnaswamy, Xinchen Yu, Dalal Alharthi, and Laura Dozal]{style="color:#0caacf;"}          | [GenAI and Automation]{style="color:#0caacf;"}                                                                                                                        |
| 12:30pm - 1:00pm                              | Lunch                                                                                                    | Break                                                                                                             | [Lunch at ENR2 provided by University of Arizona Data Science Institute]{style="color:#0caacf"}                                                                       |
| [1:00pm - 2:00pm]{style="color:#0caacf;"}     | [Afternoon Panel]{style="color:#0caacf;"}                                                                | [Andrea Thomer, Maria Pudoka, and Heidi Steiner]{style="color:#0caacf"}                                           | [Professional Skills + Tips for Breaking into the ever-changing field of Data Science]{style="color:#0caacf;"}                                                        |
| 2:00pm - 2:20pm                               | Invited Speaker Session                                                                                  | Xuan Lu                                                                                                           | Understanding Emotions in Remote Work: The Link Between Emojis and Long-Term Engagement                                                                               |
| 2:20pm - 2:40pm                               | Invited Speaker Session                                                                                  | Dianne Patterson                                                                                                  | Three Key Tools for the Future                                                                                                                                        |
| 2:40pm - 3:00pm                               | Invited Speaker Session                                                                                  | Jung Mee Park                                                                                                     | Navigating Data in Public Libraries: Challenges & Opportunities                                                                                                       |
| 3:00pm - 3:20pm                               | Invited Speaker Session                                                                                  | Desiree Andersen                                                                                                  | Predictive Modeling of Mosquito Abundance and West Nile Virus Transmission Dynamics: Insights from a Decade of Surveillance in Arizona                                |
| 3:20pm - 3:45pm                               | Data Blitz                                                                                               | Roxana Akbarsharifi, Sarah Bratt, Melika Sharifi, Anushree Biswas, and Danielle Van Boxel                         | Check out the [Data Blitz](dataBlitz2025.qmd) page!                                                                                                                   |
| [4:00pm - 6:00pm]{style="color:#0caacf;"}     | [Social]{style="color:#0caacf;"}                                                                         | [\@ [Snakes and Lattes](https://www.snakesandlattes.com/tucson)]{style="color:#0caacf"}                           | [Bring your own cash for drinks and snacks!]{style="color:#0caacf;"}                                                                                                  |

: {tbl-colwidths="\[30,25,45\]"}

\
^[\*]{style="color:#0caacf;"}^[Blue text denotes in-person only sessions]{style="color:#0caacf;"}

^[𝛼]{style="color:#0caacf;"}^provided by University of Arizona Data Science Institute
...
A computational linguist, with a specialization in the phonology of Indic languages,  and automatic speech processing. Dissertation research focuses on building models to detect the correlates of teamwork and rapport in speech communication; and assess how pattern recognition systems like neural networks can help us understand how we exchange information and unconsciously signal  feelings towards our interlocutors.

###### Xinchen Yu

Xinchen’s research lies at the intersection of natural language processing and computational social science. Her primary goal is to make computers understand and facilitate better communications between people. Her latest work centers on explaining, predicting, and preventing incivility in user-generated content.

###### Laura Dozal

Computational Social Scientist with 6+ years of specialization in information behavior and visual analysis through Computer Vision/AI, Network Science and knowledge discovery. Her dissertation research is to identify a narrative from a collection of topical images pulled from social media using a mixed methods approach.

###### Maria Pudoka

Maria Pudoka is a PhD candidate at the University of Arizona’s Steward Observatory.  In this role, she uses (mostly Python) to analyse data from ground-based and spaced-based telescopes (including the James Webb Space Telescope!) to answer cosmological and astrophysical questions about the structure of the Universe and the evolution of galaxies. Maria became involved with data science without realizing it due to the huge amounts of noisy and inhomogeneous data that is typical of astronomical observations.

###### Andrea Thomer

Dr. Andrea Thomer is an Associate Professor at the University of Arizona College of Information Science, where she studies and develops knowledge infrastructures. She has worked with natural science collections communities (and their data infrastructure) for almost 20 years.

###### Heidi Steiner

Heidi Steiner is a clinical data scientist with Boehringer Ingelheim pharmaceuticals where she leads clinical trial teams through statistical analyses equipped with R. Heidi began her data science journey while earning a PhD here at UArizona in a pharmacogenomics lab challenged by large data sets. She loves standardized data, biostatistics, and reproducible research.

## Data Blitz

Don't miss the [Data Blitz](dataBlitz2025.qmd) page!
:::
